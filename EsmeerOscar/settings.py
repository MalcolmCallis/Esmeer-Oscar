...
INSTALLED_APPS = [
    ...
    'compressor',
    'paypal',
] + get_core_apps(['EsmeerOscar.customer', 'EsmeerOscar.dashboard.partners', 'EsmeerOscar.dashboard', 'EsmeerOscar.shipping', 'EsmeerOscar.partner', 'EsmeerOscar.dashboard.catalogue', 'EsmeerOscar.checkout'])
