...
class CatalogueApplication(Application):
    ...
    def get_urls(self):
        urls = [
            ...
            #url(r'^product-type/create/$', self.product_class_create_view.as_view(), name='catalogue-class-create'),
            #url(r'^product-types/$', self.product_class_list_view.as_view(), name='catalogue-class-list'),
            #url(r'^product-type/(?P<pk>\d+)/update/$', self.product_class_update_view.as_view(), name='catalogue-class-update'),
            #url(r'^product-type/(?P<pk>\d+)/delete/$', self.product_class_delete_view.as_view(), name='catalogue-class-delete'),
        ]
